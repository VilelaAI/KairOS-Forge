...
description: Constrói, atualiza e consulta o grafo de conhecimento em .agents/grafo/ (entidades, relações com proveniência, multi-hop). Olívia. Busca por similaridade é do André; estrutura de código, o mapear-arquitetura.
---
