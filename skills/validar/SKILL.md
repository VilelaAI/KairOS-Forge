...
- Antes de `revisar`, para separar aceite funcional de code review.
...
- Se bloqueado: corrigir com <persona(s)> e usar `validar` de novo.
- Se aprovado: usar `revisar`.
```
...
Próximo passo: <corrigir com persona X | usar `revisar`>.
```
