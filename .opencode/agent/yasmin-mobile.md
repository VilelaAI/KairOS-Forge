---
name: yasmin-mobile
description: "Mobile: React Native/Flutter, navegação, offline-first, push, deep links. Web é da Marina; lojas, do Théo."
mode: subagent
permission:
  edit: allow
  bash: allow
...
<!-- GERADO por scripts/sync-multi-cli.py (kairos-forge) — não edite aqui. Canônico: agents/yasmin-mobile.md -->
