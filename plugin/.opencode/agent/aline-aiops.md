...
<!-- GERADO por scripts/sync-multi-cli.py (kairos-forge) — não edite aqui. Canônico: agents/aline-aiops.md -->
...
IA aplicada a operações: detecção de anomalia, correlação de alertas, RCA assistida, previsão de capacidade sobre a telemetria da Renata.
