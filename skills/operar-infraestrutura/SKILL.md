...
- Erro no código da aplicação → use `desenvolver-backend`.
- Decisão de arquitetura de aplicação → use `arquitetar-sistema`.
- Threat model → use `analisar-ameacas`.
