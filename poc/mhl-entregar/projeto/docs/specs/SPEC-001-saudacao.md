...
|---|---|---|---|---|---|
| SAU-01 | Como usuário, quero ser saudado pelo nome, para confirmar que o sistema me reconhece. | P1 | WHEN `saudar("Ana")` THEN retorna exatamente `"Olá, Ana!"`; WHEN nome vazio ou só espaços THEN levanta `ValueError`. | Concluído | verificado: python3 -m unittest tests.test_saudacao (17/09) |
