...
description: "Taxonomia: categorização, hierarquias de informação, ontologia do produto, design tokens. Nome de feature é da Elisa [Naming]; tom de voz, da Cora."
mode: subagent
permission:
  edit: allow
  bash: deny
