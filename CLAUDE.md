...
Plugin Claude Code / Codex CLI / OpenCode / Cursor que entrega uma fábrica de software de 64 agentes em PT-BR. Você está editando o próprio plugin.

## O que este projeto é

Plugin multi-CLI (não runtime, não SDK). 64 agentes (34 core + 30 apoio em 10 squads), 12 skills, hooks por CLI, coordenação por Laura (Tech Lead).
...
6. **Personas consistentes.** Os 64 agentes têm nomes e personalidades fixas. Não invente novos — use existentes ou peça via ADR.
...
| `agents/<id>.md` | 64 subagentes (canônico Claude Code) | manual |
