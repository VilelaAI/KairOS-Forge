...
description: "Análise exploratória, estatística, testes de hipótese e desenho de experimentos. Modelo é da Milena; LLM, do Gabriel."
mode: subagent
permission:
  edit: allow
  bash: allow
