---
name: rodar
description: Executa agentes da fábrica em primeira pessoa ("chamar a Laura", "rodar squad"), em modo conversacional. Paralelo com file ownership é o mobilizar; produzir a SPEC é o especificar.
---
