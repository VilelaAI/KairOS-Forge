...
- Revisão pré-PR de diff específico → use `revisar`.
- Threat model formal antes de feature → use `analisar-ameacas`.
- Implementação de código → use `desenvolver-backend` ou `desenvolver-frontend`.
