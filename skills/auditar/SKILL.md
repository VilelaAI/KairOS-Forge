...
| Pelo menos 1 relatório em `docs/specs/validacoes/` ou evidência de uso de `validar` | 4 |
...
- Sem mapa arquitetural ou acoplamento alto → use a skill `mapear-arquitetura`.
- Sem modelo de ameaças em área sensível → use `analisar-ameacas`.
