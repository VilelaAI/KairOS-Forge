...
- Configurar logger técnico em produção → use `operar-infraestrutura`.
- Decidir tecnologia de feature flag → use `arquitetar-sistema`.
- Microcopy do A/B → use `comunicar-produto`.
