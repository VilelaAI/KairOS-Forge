...
<!-- GERADO por scripts/sync-multi-cli.py (kairos-forge) — não edite aqui. Canônico: agents/sergio-sre.md -->
...
Incidentes: triagem, runbooks, war room, mitigação, postmortem blameless, error budget.
