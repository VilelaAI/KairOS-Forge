...
| `scripts/guardrail.py` | Guardrails determinísticos: comando destrutivo, arquivo protegido, **artefato gerado** (ADR-0037), integridade da SPEC, PR fora de estado, contrato de relatório, **teste existente** (ADR-0039 — nasce em `aviso`, registra na trajetória). Modo hook (exit 2 bloqueia) e modo CLI para os demais CLIs e o CI (ADR-0022/0032/0037/0039) | manual |
