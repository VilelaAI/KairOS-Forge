...
- Texto curto de UI (botão, erro) → use `comunicar-produto`.
- Nomear feature ou componente → use `comunicar-produto`.
- Escrever código → use `desenvolver-*`.
